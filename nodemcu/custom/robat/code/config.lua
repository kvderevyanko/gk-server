...
if (conf.wifi.mode == wifi.SOFTAP) or (conf.wifi.mode == wifi.STATIONAP) then
    ...
    conf.wifi.accessPoint.config.ssid =  "ROBAT-"..node.chipid() -- Name of the WiFi network to create.
    --conf.wifi.accessPoint.config.pwd = node.chipid() -- WiFi password for joining - at least 8 characters
    conf.wifi.accessPoint.config.pwd = "11111111" -- WiFi password for joining - at least 8 characters
